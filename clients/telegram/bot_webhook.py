...
from clients.telegram.simple_bot import (
    dp, bot, start_command, help_command, auth_command,
    logout_command, tasks_command, categories_command,
    delete_command, subtask_command, handle_message
)
...
def main():
    ...
    print(f"🚀 Запуск бота в webhook режиме")
